function [yout, kernel] = deblur_single_channel(image_name, image_format, channel_num)

kernel_size = [5 5]; % original [13 13]
sample_rate = 0.75; % original 0.75
lambda = 0.002; % original 0.002
alpha = 5500; % original 5500
